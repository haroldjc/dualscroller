...
.run(function($ionicPlatform) {
  $ionicPlatform.ready(function() {
    ...
    //            evt.stopPropagation();
    //            $scope.showPicker = false;
    //            $scope.availableTime.push({
    //             start:  startTime,
    //             end:endTime
    //            });
    //            $timeout(function() {
    //                $scope.__showPicker = true;
    //            }, 100);
    //        };
    ...
    //            return array;
    //        };
    //        $scope.showTimePicker = function (evt) {
    //            evt.stopPropagation();
    //            $scope.__showPicker = true;
    //            $scope.showPicker = !$scope.showPicker;
    //            if($scope.showPicker){
    //                $timeout(function () {
    //                    $('.height-ctrl2')[0].style.height = (screen.height - dualScrollHeight)+60+'px';
    //                },100)
    //            }
